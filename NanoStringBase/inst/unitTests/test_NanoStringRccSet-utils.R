...
test_NanoStringRccSet_utils_summary <- function() {
  ...
  checkEquals(cbind(N = 3,
                    ...
                    Skewness = 0,
                    Kurtosis = NA_real_,
                    GM_LCL95 = c(0.0699364473, 0.2108001028, 0.6394432507, 1.1919981586),
                    GeomMean = c(2.519842100, 3.556893304, 4.932424149, 6.135792440),
                    GM_UCL95 = c(90.79106035, 60.01652661, 38.04686023, 31.58389851),
                    Min = 0:3,
                    Q1 = 2:5,
                    Median = 4:7,
                    Q3 = 6:9,
  ...
  checkEquals(cbind(N = 4,
                    ...
                    Skewness = 0,
                    Kurtosis = -1.2,
                    GM_LCL95 = c(0.3751849728, 3.668188416, 7.584766676),
                    GeomMean = c(1.316074013, 5.383563271, 9.433683366),
                    GM_UCL95 = c(4.616525003, 7.901108178, 11.733305143),
                    Min = c(0, 4, 8),
                    Q1 = c(0.75, 4.75, 8.75),
...
test_NanoStringRccSet_utils_summary_GROUP <- function() {
  ...
  checkEquals(list(A =
                     cbind(N = 2,
                           ...
                           Skewness = NA_real_,
                           Kurtosis = NA_real_,
                           GM_LCL95 = c(2.588760437e-06, 8.106941001e-05, 3.223965976e-03, 2.105307130e-02),
                           GeomMean = c(1.414213562, 2.236067977, 3.464101615, 4.582575695),
                           GM_UCL95 = c(772570.5210908, 61675.5444443, 3722.1236485, 997.4791658),
                           Min = 0:3,
                           Q1 = 1:4,
                           Median = 2:5,
                           Q3 = 3:6,
